...
public abstract class AbstractOAuth2SecurityExceptionHandler {
     ...
     * 
     * Note : Only the {@link ResponseEntity} should be enhanced. If the response body is to be customized, it should be
     * done at the {@link WebResponseExceptionTranslator} level.
     * 
     ...
     */
    protected ResponseEntity<?> enhanceResponse(
