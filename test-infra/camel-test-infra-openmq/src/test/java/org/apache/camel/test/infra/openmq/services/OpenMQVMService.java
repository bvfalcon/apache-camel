 ...
 */
public class OpenMQVMService extends AbstractOpenMQEmbeddedService {
    private static final Logger LOG = LoggerFactory.getLogger(OpenMQVMService.class);

    public OpenMQVMService() {
        this(OpenMQEmbeddedServiceBuilder.defaultBroker().brokerInstance());
    }

    public OpenMQVMService(BrokerInstance brokerInstance) {
