...
package com.consol.citrus.http.server.jakarta;
...
import com.consol.citrus.http.servlet.jakarta.CitrusDispatcherServlet;
import com.consol.citrus.report.MessageListeners;
import com.consol.citrus.server.jakarta.AbstractServer;
 ...
 * Incoming requests are handled with Spring MVC.
 *
        ...
        synchronized (serverLock) {
            ...
            if (useRootContextAsParent && getReferenceResolver() instanceof SpringBeanReferenceResolver) {
                contextHandler.setAttribute(WebApplicationContext.ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE,
                        new ParentDelegatingWebApplicationContext(
                                ((SpringBeanReferenceResolver) getReferenceResolver()).getApplicationContext()));
            }
