 ...
 */
public class OpenMQPersistentVMService extends AbstractOpenMQEmbeddedService {
    private static final Logger LOG = LoggerFactory.getLogger(OpenMQPersistentVMService.class);

    public OpenMQPersistentVMService() {
        this(OpenMQEmbeddedServiceBuilder.persistentBroker().brokerInstance());
    }

    public OpenMQPersistentVMService(BrokerInstance brokerInstance) {
